...
var statuses = [`Security Bot`]; //Bot Status
var timers = 2;
const owners = ["1257310604746817597","1230107633915265067"]; //Bot  owners
client.login(`MTI4Mzc3ODU2OTEyNjAxOTExMg.GPVDIJ.HM1M9Bd3DvXk_cDJIp0Y4XRb1Tb_ACptX-j-UQ`);//bot token here
client.on("ready", () => {
